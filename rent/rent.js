...
function validateMen() {
    ...
    menError.innerHTML = '<span class="material-symbols-outlined">check_circle</span>';
    return true;
}
...
function validateFemale() {
    ...
    femaleError.innerHTML = '<span class="material-symbols-outlined">check_circle</span>';
    return true;
}
